...
public class NSInterpreter implements NSOps, NSTypes {
    ...
    public NSObject interpret(NSClass currentClass, List<NSInsn> insns, NSVariable... startVariables) throws NSNoSuchMethodException,
            NSClassNotFoundException, NSVirtualMachineException {
        int index = 0;
