...
public class CompilerState {
    ...
    public CompilerState(HashMap<String, Integer> varName2Id, HashMap<String, NSType> varName2Type, int varId, String labelBase,
            int labelID, NSFuncDef currentMethodDef) {
